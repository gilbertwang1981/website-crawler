CREATE TABLE `fakhruddinsouq_product_scrapy` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4210 DEFAULT CHARSET=utf8 COMMENT='fakhruddinsouq数据爬虫表';
...
CREATE TABLE `jubilee_product_scrapy` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2663 DEFAULT CHARSET=utf8 COMMENT='jubilee数据爬虫表';