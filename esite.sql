...
CREATE TABLE `jamshidramin_product_scrapy` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `title` varchar(512) NOT NULL DEFAULT '' COMMENT '商品标题',
  `description` varchar(8192) NOT NULL DEFAULT '' COMMENT '商品描述',
  `images` varchar(8192) NOT NULL DEFAULT '' COMMENT '商品图片',
  ...
  `is_deleted` tinyint(4) DEFAULT '0' COMMENT '软删除字段',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='jamshidramin数据爬虫表';

CREATE TABLE `common_product_scrapy` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `title` varchar(512) NOT NULL DEFAULT '' COMMENT '商品标题',
  `description` varchar(8192) NOT NULL DEFAULT '' COMMENT '商品描述',
  `images` varchar(8192) NOT NULL DEFAULT '' COMMENT '商品图片',
  ...
  `is_deleted` tinyint(4) DEFAULT '0' COMMENT '软删除字段',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='数据爬虫表';